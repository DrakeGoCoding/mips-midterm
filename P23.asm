...
.data
	...
	isValid: .word 1
	validMessage: .asciiz " is a surpassing word"
	invalidMessage: .asciiz " is not a surpassing word"
.text
...
beqz $a0, not_valid
printStringString(string, validMessage)
j end_main
not_valid:
printStringString(string, invalidMessage)
